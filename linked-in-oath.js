...
var APIKey = "758vhpto6yd42c";
var APIKeySecret = "1duk8gAsbU7RMpWC";
// var callbackURL = "http://localhost:1337/callback/";
// var ip_address = "10.0.12.41";
var ip_address = "127.0.0.1";
var callbackURL = "http://" + ip_address + ":1337/callback/";
var APIVersion = "v1";

// These are all of the scope variables. Remove them based on your needs
// var APIScope = 'r_basicprofile r_emailaddress rw_nus rw_groups w_messages';
var APIScope = 'r_basicprofile r_emailaddress';
var destination = 'http://localhost:8889/static/index.html';
...
console.log('Visit http://' + ip_address + ':1337/ in your browser to test the LinkedIn Oauth2 API Authentication');
...
var OauthStep3 = function(request, response, access_token, APICall, callback) {
        ...
        var req = https.request(options, function(res) {
            ...
            res.on('data', function(d) {
                ...
                ar = JSON.parse(d)
                var final_dest = destination + '?firstName=' + encodeURIComponent(ar['firstName']) + '&lastName=' + encodeURIComponent(ar['lastName']) + '&headline=' + encodeURIComponent(ar['headline']) + '&pictureUrl=' + encodeURIComponent(ar['pictureUrl']);
                console.log(response);
                // YOUR NEXT STEP HERE
                response.writeHead(302, {'Location': final_dest});
                response.end();
            });
        });
